...
def main(stdscr): 
  ...
  tetriminos(stdscr, 'I-block2')
  tetriminos(stdscr, 'T-block')
  tetriminos(stdscr, 'T-block2')
  tetriminos(stdscr, 'T-block3')
  tetriminos(stdscr, 'T-block4')
  tetriminos(stdscr, 'J-block')
  tetriminos(stdscr, 'J-block2')
  tetriminos(stdscr, 'J-block3')
  tetriminos(stdscr, 'J-block4')
  tetriminos(stdscr, 'L-block')
  tetriminos(stdscr, 'L-block2')
  tetriminos(stdscr, 'L-block3')
  tetriminos(stdscr, 'L-block4')
  tetriminos(stdscr, 'S-block')
  tetriminos(stdscr, 'S-block2')
  tetriminos(stdscr, 'Z-block')
  tetriminos(stdscr, 'Z-block2')
